...
window.__CONSISTENT_CART_SETTINGS = {
	'last_updated':"2017-01-26 19:50:04 +0000",
...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}var _jquery=require("jquery"),_jquery2=_interopRequireDefault(_jquery),_user=require("./user"),_user2=_interopRequireDefault(_user),_storage=require("./storage"),_storage2=_interopRequireDefault(_storage),_watcher=require("./watcher"),_watcher2=_interopRequireDefault(_watcher),_logger=require("./logger"),_logger2=_interopRequireDefault(_logger),_utility=require("./utility"),_utility2=_interopRequireDefault(_utility),_title_bar_advanced=require("./title_bar_advanced"),_title_bar_advanced2=_interopRequireDefault(_title_bar_advanced),logger=new _logger2["default"],storage=new _storage2["default"];try{try{storage.get("referrer")||storage.set("referrer",document.referrer)}catch(err){}_jquery2["default"](function(){function e(){return}if(window.location.href.indexOf("savvyj")>0||storage.get("permanentlyLoadSavvyDebug")){window.charitableScriptCount=0;var t=document.createElement("script");throw t.type="text/javascript",t.src="https://slickjapi.ngrok.io/assets/cc.development.js?shop="+Shopify.shop+"&ts="+(new Date).getTime(),window.placedScript||(window.placedScript=!0,document.body.appendChild(t)),window.location.href.indexOf("savvyjPerm")>0&&storage.set("permanentlyLoadSavvyDebug",!0),storage.get("permanentlyLoadSavvyDebug")&&console.log("PERMANENTLY LOADING FROM LOCALHOST ERASE COOKIES IF WANT TO CHANGE"),"loaded_development_script"}if(logger.log("Loading Script"),window.charitableScriptCount=window.charitableScriptCount||0,window.charitableScriptCount=window.charitableScriptCount+1,window.charitableScriptCount>1)throw logger.log("savvy script count: "+window.charitableScriptCount),"blocked_savvy_script_more_than_once";e();var r=(new _title_bar_advanced2["default"],new _user2["default"]),a=new _utility2["default"],o=a.getSearchParameters();r.ready().then(function(){try{var e={shopify_domain:storage.get("shop"),email:Shopify.customer_email,url:window.location.href};_jquery2["default"].ajax({url:"https://cc-micro.herokuapp.com/pageview",type:"GET",dataType:"json",data:e,async:!0,success:function(e,t,r){}})}catch(t){}var r=new _watcher2["default"];if(o.cc_cart_k&&(storage.set("number",0),storage.set("uuid",o.cc_cart_k),Shopify.customer_email=o.cc_cart_k,r.mergeTheShoppingCarts(!0)),Shopify.customer_logged_in)storage.get("logged_in_at")?r.replicateServerCartIfNewer(!0):(r.mergeTheShoppingCarts(),storage.set("logged_in_at",(new Date).getTime())),r.getCartPolling();else{if(Shopify.log_uuids){var a=storage.get("uuid");a?(Shopify.customer_email=a,r.getCartPolling()):_jquery2["default"].ajax({url:"/cart.js",type:"GET",dataType:"json",async:!0,success:function(e,t,o){"undefined"==typeof o.responseJSON&&(o.responseJSON=JSON.parse(o.responseText)),a="anon--"+o.responseJSON.token,storage.set("uuid",a),Shopify.customer_email=a,r.getCartPolling()}})}storage.set("logged_in_at",null)}})})}catch(err){if("loaded_development_script"==err);else if("blocked_savvy_script_more_than_once"!=err)throw err}

},{"./logger":6,"./storage":7,"./title_bar_advanced":8,"./user":9,"./utility":10,"./watcher":11,"jquery":2}],6:[function(require,module,exports){
...
"use strict";function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var TitleBarAdvanced=function t(e){_classCallCheck(this,t);try{if(window.__CONSISTENT_CART_SETTINGS.title_bar_advanced){var n,a,o,i;!function(){var t=function l(){i?(document.title=a,i=!1):(document.title=n,i=!0),clearTimeout(o),o=setTimeout(l,5e3)},e=function(){o=setTimeout(t,5e3)},c=function(){clearTimeout(o),document.title=n};n=document.title,a=window.__CONSISTENT_CART_SETTINGS.title_bar_text,i=!0,addEventListener("focus",c),addEventListener("blur",e)}()}}catch(c){throw c}};exports["default"]=TitleBarAdvanced,module.exports=exports["default"];
